...
-- Dumping data for table hospital.messages: ~27 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=latin1 COMMENT='Used to Capture Patients Information';

-- Dumping data for table hospital.patients: ~4 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=latin1 COMMENT='Stores patient diseases and treatments administred';

-- Dumping data for table hospital.patientsinfo: ~8 rows (approximately)
...
-- Dumping data for table hospital.roles: ~48 rows (approximately)
...
-- Dumping data for table hospital.userroles: ~93 rows (approximately)
