<%-- 
    Document   : index
    Created on : Feb 6, 2020, 5:39:22 PM
    Author     : Shymu
--%>
    ...
    <body>
         ...
         <div class="container">
            ...
            <ul id="myTab" class="nav nav-pills col-sm-12" style="text-align: center; ">
                ...
                <li class="col-sm-2" style="padding:0;margin:0;" id="newusertabid" ><a href="#newusertab" data-toggle="tab">Users</a></li>
                        ...
                        <div class="col-sm-12" style="padding: 5px;min-width: 300px;" id="">
                            <div class="well">  
                                <div class="" style="margin: 2px;padding: 8px;min-width: 210px;margin-left: 0;">
                                    <form role="form" name="searchreportform" id="searchreportform" class="form-horizontal" action="../downloadadminreport" method="get" target="_blank" enctype="multipart/form-data">
                                        <div class="row">
